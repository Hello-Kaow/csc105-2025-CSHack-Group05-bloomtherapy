            ...
            <div className="flex flex-col border-1 w-[250px] rounded-[10px] shadow-[0_0_20px_rgba(0,0,0,0.15)] md:w-[400px]">
                ...
                <div className="flex flex-col justify-center items-center">
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className="flex justify-center items-center bg-[#A2D0AA] w-[80px] h-[30px] rounded-[100px] text-white text-[10px] font-bold tracking-widest m-[20px] md:text-[14px] md:w-[120px] md:h-[42px] md:m-[40px] disabled:opacity-70 disabled:cursor-not-allowed hover:bg-[#98B99E] transition-colors">
                            {isLoading ? (
